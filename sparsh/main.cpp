...
int main(){
    ...
    if (game_state == 0) {
        ...
        while (true) {
            ...
            //     // lives, ball.speedX, ball.speedY, paddle.width = apply_power_up(ball.speedX, ball.speedY, paddle.width, specialTileType);
            //     // Process reward/penalty
            //     switch (specialTileType) {
            //         case 0:
            //             lives = apply_power_up()
            //         /* Green tile logic */ break;
